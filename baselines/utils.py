    ...
    for p, pattern in patterns.items():
        if p in graphs:
            for g, graph in graphs[p].items():
                ...
                if num % 4 == 0 and train_count < train_length:
                    if train_size_count < train_size:
                        train_data.append(x)
                        train_size_count += 1
                    train_count += 1
                elif num % 4 == 1 and dev_count < dev_length:
                    dev_data.append(x)
                    dev_count += 1
                else:
                    test_data.append(x)
    ...
    for p, pattern in patterns.items():
        if p in graphs:
            for g, graph in graphs[p].items():
                ...
                if (num % 4 == 0 or num % 4 == 1) and train_count < train_length:
                    train_data.append(x)
                    train_count += 1
                elif num % 4 == 2 and dev_count < dev_length:
                    dev_data.append(x)
                    dev_count += 1
                else:
                    test_data.append(x)
